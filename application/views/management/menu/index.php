        ...
        <div class="modal-content animated bounceInRight">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo base_url('menu') ?>">
                <div class="modal-body">
                    ...
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Menu </label>
                        <div class="col-sm-10"><input type="text" name="title" class="form-control" placeholder="Masukkan nama menu..." autocomplete="off" autofocus></div>
                    </div>
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Title </label>
                        <div class="col-sm-10"><input type="text" name="desc" class="form-control" placeholder="Masukkan nama title..." autocomplete="off" autofocus></div>
                    </div>
            ...
            <div class="modal-content animated bounceInRight">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('menu/Edit') ?>">
                    <div class="modal-body">
                        ...
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Title </label>
                            <div class="col-sm-10"><input type="text" name="desc" value="<?= $tampil['desc']; ?>" class="form-control" placeholder="Masukkan nama description..." autocomplete="off" autofocus></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Url </label>
