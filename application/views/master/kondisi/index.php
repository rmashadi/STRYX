                                        ...
                                        <td>
                                            <div class="btn-group shadow">
                                                ...
                                                <ul class="dropdown-menu shadow">
                                                    ...
                                                    <li><a class="dropdown-item" href="<?= base_url('kondisi/delete/') . $tampil['id_kondisi'] ?>" onclick="return confirm('Yakin menghapus data <?= $tampil['kondisi']; ?>?');"><i class="glyphicon glyphicon-trash"></i> Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Kondisi Barang</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>

            <form class="form-horizontal" method="POST" action="<?php echo base_url('kondisi') ?>">
                <div class="modal-body">
                    <div class="form-group row"><label class="col-sm-3 col-form-label">Kondisi Barang</label>
                        <div class="col-sm-9"><input type="text" name="kondisi" class="form-control" placeholder="Masukkan kondisi barang..." autocomplete="off" autofocus></div>
                    </div>
...
<!-- ==================================  MODAL EDIT  ========================================= -->
<?php foreach ($kondisi as $tampil) : ?>
    <div id="modalEdit<?php echo $tampil['id_kondisi'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Kondisi Barang</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>

                <form class="form-horizontal" method="post" action="<?php echo base_url('kondisi/Edit') ?>">
                    <div class="modal-body">
                        <input name="id_kondisi" type="hidden" value="<?php echo $tampil['id_kondisi']; ?>">

                        <div class="form-group row"><label class="col-sm-3 col-form-label">Kondisi Barang</label>
                            <div class="col-sm-9"><input type="text" name="kondisi" value="<?= $tampil['kondisi']; ?>" class="form-control" placeholder="Masukkan kondisi barang..." autocomplete="off" autofocus></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-3 col-form-label">Keterangan</label>
