...
<h4 style="color: #ff3333; font-family: 'JetBrains Mono', monospace;">An uncaught Exception was encountered</h4>

<p style="color: #94a3b8;">Type: <span style="color: #e2e8f0;"><?php echo get_class($exception); ?></span></p>
<p style="color: #94a3b8;">Message: <span style="color: #e2e8f0;"><?php echo $message; ?></span></p>
<p style="color: #94a3b8;">Filename: <span style="color: #ffb700; font-family: 'JetBrains Mono', monospace; font-size: 12px;"><?php echo $exception->getFile(); ?></span></p>
<p style="color: #94a3b8;">Line Number: <span style="color: #00d4ff; font-family: 'JetBrains Mono', monospace;"><?php echo $exception->getLine(); ?></span></p>
